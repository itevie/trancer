      ...
      .addFields([
        {
          name: "Decks",
          value:
            `Each card belongs to a deck, for example there is a deck called ONE, and all the cards are ONE characters.` +
        ...
        },
        {
          name: "Viewing Cards",
          value:
            `To view the cards you have: \`$prefixcards\`` +
